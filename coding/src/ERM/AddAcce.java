...
public class AddAcce extends JFrame {
	...
	public AddAcce() {
		...
		JLabel label = new JLabel("Add Accessories");
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String str = "insert into Accessories value(?,?,?,?,?,?,?,?)";
