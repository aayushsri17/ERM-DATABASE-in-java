...
public class addretail extends JFrame {
	...
	public addretail() {
		...
		JLabel lblAddRetailData = new JLabel("Add Retail Data");
		lblAddRetailData.setBounds(180, 11, 80, 14);
		contentPane.add(lblAddRetailData);
		...
		lblNewLabel.setBounds(31, 70, 80, 14);
		...
		final JButton btnAddData = new JButton("Add Data");
		btnAddData.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String str = "insert into addretail value(?,?,?,?,?,?,?,?)";
				...
				if (flag ==0)
				{
					JOptionPane.showMessageDialog(btnAddData,this,"Data Not Added",JOptionPane.ERROR_MESSAGE);
				...
				if (flag ==1)
				{
					...
					{
					JOptionPane.showMessageDialog(btnAddData,this,"Data Added",JOptionPane.INFORMATION_MESSAGE);
		...
		btnAddData.setBounds(145, 343, 89, 23);
		...
		lblQuantityAvailable.setBounds(31, 95, 89, 14);
		...
		btnBack.setBounds(22, 343, 89, 23);
		...
		btnHome.setBounds(279, 343, 89, 23);
