...
public class AddHomeTextile extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AddHomeTextile frame = new AddHomeTextile();
	 ...
	 * Create the frame.
	 */
	public AddHomeTextile() {
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 467, 490);
		...
		panel.setBounds(10, 11, 435, 418);
		contentPane.add(panel);
		
		JLabel label = new JLabel("Add Home Textile");
		label.setBounds(180, 11, 163, 14);
		panel.add(label);
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String str = "insert into HomeTextile value(?,?,?,?,?,?,?,?)";
